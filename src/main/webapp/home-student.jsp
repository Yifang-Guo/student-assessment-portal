...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<a class="navbar-brand" href="http://localhost:8080/SAssessmentPortal/Student">Student Assessment System</a>
			...
			<tbody>
				<c:forEach items="${requestScope.courses}" var="i">
					<tr>
						...
						<td>${i[2]}</td>
						<td>
							<form class="form-inline" method="get" action="CheckResult">
								<input type="hidden" name="course_id" value="${i[0]}">
								<input type="hidden" name="userid" value="${requestScope.userid}">
								<button type="submit" class="btn btn-outline-danger btn-sm">Check Result</button>
							</form>
						</td>
					</tr>
				</c:forEach>
